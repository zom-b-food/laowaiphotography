    ...
    <div class="body row">
        ...
        <!-- Blog Entries Column -->
            ...
            <div class="col-md-3">
                ...
                <hr/>
                <div class="sbPic"><img src="/resources/images/ui/laowaiMEbig.png" width="300px"
                                           height="592px" class="img-responsive hideSM"/></div>
            </div>
            <div class="col-md-6">


                <iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0 "width="582" height="418" style="margin-top:20px;" src="https://maps.google.com/maps?hl=en&q=12121 admiralty way, everett, wa 98204&ie=UTF8&t=m&z=15&iwloc=B&output=embed">
                    </iframe>
                <hr/>
