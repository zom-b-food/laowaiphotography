...
<script language="JavaScript" src="<%=request.getContextPath()%>/scripts/buttons.js"></script>
<style type="text/css">
...
<div id="container-page">
  <div class="watermark"><img src="<%=request.getContextPath()%>/images/bannerS2.jpg"></div>
  <?php include '../inc/splashNav.php" %>
  <div class="underNav">
  ...
  <div style="position:relative; top:160px; left:6px;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		%>
          <%= oops %></td>
        <td><form action="<%=request.getContextPath()%>/servlet/pool.LoginServlet" method="post" name="login">
