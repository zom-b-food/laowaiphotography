    ...
    <div class="container wrapper">
        ...
        <div class="body row">
            ...
            <div class="col-md-6">
                ...
                <p>The fee is set for individuals or groups up to 4 people (or other furry loved ones) at my studio or
                    location of their choice. ($25 for
                ...
                <ul class="rates">
                    <li>Hourly rate for weddings (and other special services) is $400 which means I can shoot your whole
                        wedding
                        for 1200 bucks (3-hour minimum). After all, it's an event that comes only two or three times in
                        a
                        lifetime ;), and I want to make each one better than the last. Incidentally, go ahead and take
                        $100 off
                        ...
                        <ul class="sub">
                            ...
                            <li>Professionally printed photo books available through my printing partners; costs vary.
                            </li>
                        </ul>
                    </li>
                </ul>
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <ul class="rates">
                                    ...
                                    <li>Location sessions in Oakland/East Bay are included in session fee. Location
                                        sessions in San Francisco
                                        and the penisula are an additional $25. Travel to locations beyond the bay area
                                        can also be arranged.</li>
                                    ...
                                    <li>Session invoices are generated at time of booking. Partial payment is required
                                        upon receipt by mail.
                                        This locks in your time/date. <br />
                                        <div class="rights"> Rights: LaoWai Photography and Adam Marsh retains copyright
                                            of images and usage rights only for
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse">
                            <div class="panel-body">
                                <ul class="rates">
                                    ...
                                    <li>Professionally printed photo books available through my printing partners; costs
                                        vary.</li>
                                </ul>
                            </div>
                        </div>
